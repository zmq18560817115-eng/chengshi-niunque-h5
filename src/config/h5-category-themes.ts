...
> = {
  ...
  "review-assurance": [
    { title: "配方与标签", description: sharedCardDescription, buttonText: "查看4份报告", statusBaseArtwork: { src: runtimeAsset("review-status-fish-1.png"), width: 413, height: 189 } },
    { title: "原料与工艺", description: sharedCardDescription, buttonText: "查看3份报告", statusBaseArtwork: { src: runtimeAsset("review-status-fish-2.png"), width: 413, height: 189 } },
    { title: "稳定性与感官", description: sharedCardDescription, buttonText: "查看2份报告", statusBaseArtwork: { src: runtimeAsset("review-status-fish-3.png"), width: 413, height: 189 } },
  ],
  "production-traceability": [
    { title: "生产资质", description: sharedCardDescription, buttonText: "查看2份报告", statusBaseArtwork: { src: runtimeAsset("traceability-status-fish-1.png"), width: 412, height: 189 } },
    { title: "质量管理", description: sharedCardDescription, buttonText: "查看3份报告", statusBaseArtwork: { src: runtimeAsset("traceability-status-fish-2.png"), width: 412, height: 189 } },
  ],
};
...
function completeCategoryReadinessAssets(slug: keyof typeof categoryArtworkLayers) {
  return [...new Set([
    ...
    ...categoryCardFallbacks[slug].map((fallback) => fallback.statusBaseArtwork?.src),
