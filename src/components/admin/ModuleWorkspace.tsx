...
type Asset = { id: string; title: string; description: string | null; assetType: AssetType; openMode: AssetOpenMode; storageKey: string | null; mimeType?: string | null; externalUrl: string | null; sortOrder: number; contentStatus: ContentStatus; pages: Array<{ id: string; pageNumber: number; storageKey?: string | null; mimeType?: string | null }> };
