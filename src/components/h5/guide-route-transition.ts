...
export const guideRouteHintSrc = "/design/2026-09-07/guide/swipe-up-hint-v2.png";
export const guideTransitionTravelRatio = 0.26;

const guideRouteArchSrc = "/design/2026-09-07/guide/guide-arch.webp";
const guideRouteCharacterSrc = "/design/2026-09-07/guide/guide-character-open.webp";
...
export const guideRouteStageSettleMs = 120;
