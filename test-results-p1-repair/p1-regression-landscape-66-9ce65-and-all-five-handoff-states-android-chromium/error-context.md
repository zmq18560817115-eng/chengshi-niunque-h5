...
- Name: p1-regression.spec.ts >> landscape-667x375 preserves composition and all five handoff states
...
Locator: locator('.guide-landscape-composition')
Expected: visible
Error: strict mode violation: locator('.guide-landscape-composition') resolved to 2 elements:
    1) <div aria-hidden="true" class="guide-landscape-composition">…</div> aka locator('div').nth(3)
    2) <div aria-hidden="true" class="guide-landscape-composition">…</div> aka locator('.h5-guide-route-snapshot > .guide-landscape-composition')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('.guide-landscape-composition')
...
- generic [active] [ref=e1]:
  - main [ref=e2]:
    - region "品牌引导页" [ref=e4]:
      - heading "Honest Nutri 品牌引导" [level=1] [ref=e10]
      - generic [ref=e11]: 向上滑动，或点击下方提示进入档案
      - button "进入档案" [ref=e12] [cursor=pointer]
  - alert [ref=e13]
```
