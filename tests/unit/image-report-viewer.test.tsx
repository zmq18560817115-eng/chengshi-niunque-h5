...
describe("ImageReportViewer", () => {
  ...
  it("keeps zoom inside a fixed viewer, supports 1–3x zoom and retries an isolated failure", async () => {
    ...
    expect(stage).toHaveAttribute("aria-label", expect.stringContaining("区域内缩放"));
